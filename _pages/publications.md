...
Implemented using U-Net,U-net with skip connections and M-Net(Encoder-Decoder Convolutional Neural
Network) using dice coefficient as metric. Achieved dice score of 67%.
[Code](https://github.com/angadbajwa23/Segmentation-of-2D-Brain-MR-Images-using-Deep-Neural-Architectures)

- Extract- Text Extraction
Inspired from Google Tesseract and based on Convolution Neural Networks as well as OpenCV.
EXTRACT is an Optical Character Recognition (OCR) engine to extract text from images and convert
them to plain text.
...
libraries.
[Code](https://github.com/angadbajwa23/Analyzing-Air-Pollution-in-Delhi)
...
[Code](https://github.com/angadbajwa23/promoting-innovation-in-nitt)
...
recognition.
[Code](https://github.com/angadbajwa23/NirBhay)